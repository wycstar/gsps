...
def copy_details_from_input_dicom(dicom, input_dicom):
    data_elements = [
        'PatientID', 'PatientBirthDate', 'StudyInstanceUID',
        'StudyDescription', 'PatientName', 'PatientSex', 'StudyID',
        'StudyDate', 'StudyTime', 'ReferringPhysicianName', 'AccessionNumber'
    ]
...
def get_text_annotation(text, bounding_box, anchor_point=None):
    ...
    ds_text_object.BoundingBoxAnnotationUnits = bounding_box[
        "BoundingBoxAnnotationUnits"]
    ds_text_object.UnformattedTextValue = text
    ds_text_object.BoundingBoxTopLeftHandCorner = bounding_box[
        "BoundingBoxTopLeftHandCorner"]
    ds_text_object.BoundingBoxBottomRightHandCorner = bounding_box[
        "BoundingBoxBottomRightHandCorner"]
    ds_text_object.BoundingBoxTextHorizontalJustification = "LEFT"

    if anchor_point is not None:
        ds_text_object.AnchorPointAnnotationUnits = anchor_point[
            "AnchorPointAnnotationUnits"]
        ds_text_object.AnchorPoint = anchor_point["AnchorPoint"]
        ds_text_object.AnchorPointVisibility = anchor_point[
