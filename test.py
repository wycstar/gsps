...
text_bounding_box = {
    ...
    "BoundingBoxTopLeftHandCorner": top_left,
    "BoundingBoxBottomRightHandCorner": bottom_right
}

# add the annotation
input_dicom = gsps.add_graphic_layer(input_dicom, "LAYER1", "for annotation",
                                     1)
input_dicom = gsps.add_displayed_area_selection(input_dicom,
                                                input_dicom.Columns,
                                                input_dicom.Rows)
text = gsps.get_text_annotation(annotation_text, text_bounding_box,
                                anchor_point)
...
input_dicom = gsps.add_graphic_annotations(input_dicom, "LAYER1",
                                           [circle, circle2, circle3], [text])
